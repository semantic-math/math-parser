...
class Parser {
    ...
    // Continues calling 'explicitMul' until there is no '+' or '-' found and
    // then returns the parsed expression.
    ...
    // fraction or just the output of 'factor'.
    ...
    // Returns an identifier or placeholder from the current token
